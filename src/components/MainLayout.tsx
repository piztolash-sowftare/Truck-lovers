        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 z-10">
          ...
          <div className="w-full space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button 
                onClick={() => login('facebook-user@trucklovers.ro')}
                className="bg-white/5 hover:bg-white/10 text-white font-bold py-3 rounded-2xl flex items-center justify-center gap-2 border border-white/10 transition-all"
              >
                <div className="w-5 h-5 bg-blue-600 rounded flex items-center justify-center text-[10px] font-black">f</div>
                Facebook
              </button>
              <button 
                onClick={() => login('google-user@trucklovers.ro')}
                className="bg-white/5 hover:bg-white/10 text-white font-bold py-3 rounded-2xl flex items-center justify-center gap-2 border border-white/10 transition-all"
              >
