      ...
      <header className="flex-none ultra-glass px-6 py-5 flex items-center justify-between z-50">
        <div className="flex items-center gap-3">
          <Link href="/" className="relative active:scale-90 transition-all">
            ...
            <div className="relative bg-gradient-to-tr from-[#ff385c] to-[#bd1e59] w-10 h-10 rounded-2xl flex items-center justify-center shadow-lg shadow-red-500/20 rotate-[-4deg]">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-2">
              ...
              {user?.isAdmin && (
                <div className="bg-gradient-to-r from-[#ffb800] to-[#ff8a00] text-black text-[7px] font-black px-1.5 py-0.5 rounded shadow-[0_0_15px_rgba(255,184,0,0.3)] border border-yellow-200/50 animate-pulse-gold">ELITE A</div>
              )}
            </div>
            <span className="text-[7px] font-black text-slate-500 uppercase tracking-[0.4em] mt-1 flex items-center gap-1">
              <div className="w-1 h-1 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)]" /> Connected
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/profile" className="relative active:scale-95 transition-all">
             <div className="w-11 h-11 rounded-full border-2 border-white/10 overflow-hidden bg-slate-900 ring-2 ring-red-600/5 relative group">
               {user.image ? (
             ...
             <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 border-4 border-black rounded-full shadow-lg" />
          </Link>
        </div>
      </header>
