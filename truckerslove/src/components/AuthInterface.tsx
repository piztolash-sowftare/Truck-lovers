  ...
  return (
    <div className="max-w-md mx-auto h-screen bg-slate-950 flex flex-col relative overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-10 z-10">
        ...
        >
          <div className="absolute inset-0 bg-red-600 blur-[100px] opacity-30 animate-pulse" />
        ...
        <div className="text-center mb-10">
          ...
          >
            TRUCK<span className="text-red-600 drop-shadow-[0_0_15px_rgba(239,68,68,0.5)]">LOVERS</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.5 }}
            className="text-slate-500 text-[8px] font-black uppercase tracking-[0.8em] mt-3"
          >
            Elite Road Connection
          </motion.p>
        </div>
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest px-2">Eu sunt</label>
                  <select 
                    name="gender"
                    required
                    className="w-full bg-slate-900 border border-white/[0.05] rounded-2xl py-3 px-4 text-white focus:ring-1 focus:ring-red-600/50 outline-none text-xs font-bold appearance-none"
                  >
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-black text-slate-500 uppercase tracking-widest px-2">Caut</label>
                  <select 
                    name="lookingFor"
                    required
                    className="w-full bg-slate-900 border border-white/[0.05] rounded-2xl py-3 px-4 text-white focus:ring-1 focus:ring-red-600/50 outline-none text-xs font-bold appearance-none"
