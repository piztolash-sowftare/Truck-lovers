    ...
    <div className="max-w-md mx-auto h-screen bg-slate-950 flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 z-10">
        ...
        <div className="grid grid-cols-2 gap-4 w-full">
          <button className="bg-white/5 hover:bg-white/10 text-white font-bold py-3 rounded-2xl flex items-center justify-center gap-2 border border-white/10 transition-all text-xs">
