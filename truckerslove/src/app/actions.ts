...
import { db } from '@/db';
import { users, swipes, globalMessages, parkings, matches, privateMessages, profileVisits, parkingMessages } from '@/db/schema';
...
export async function getUsersToSwipe(filters: { 
  ...
  // Auto Filter based on user's preference if no filter override is provided
